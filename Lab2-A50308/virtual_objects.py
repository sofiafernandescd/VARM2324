...
def detect_and_register_virtual_objects(mtx, dist, dict_name=aruco.DICT_6X6_250):
...
def load_calibration_parameters(file_path='calibrations/calib_image_aruco_board.npz'):
...
if __name__ == '__main__':
    ...
    detect_and_register_virtual_objects(mtx, dist, dict_name=aruco.DICT_7X7_50)
